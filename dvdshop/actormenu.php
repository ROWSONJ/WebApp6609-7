...
<body>
    <div class="container">
                ...
                <?php
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["actorid"]."</td>"."<td>".$row["aname"]." ".$row["alastname"]."</td>"."<td>".$row["aaddress"]."</td>"."<td>".$row["atelephone"]."</td>"."<td>"."<a class='btn btn-dark' href='editactbio.php?actorid=".$row["actorid"]."'>Edit</a>"."</td>";
                            echo "</tr>";    
                        }
                    }else {
                        echo "0 results";
        ...
        <a class="btn btn-success" href='insertactbio.php'>Insert Actor</a>
    </div>
</body>
